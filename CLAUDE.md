...
`campaigns/fail-academy/planning/*.json` — these are working docs, NOT live
...
- The antagonist is a former student ("too far gone," made a deal with Orcus)
  — still unnamed/ungendered as of this note.
